...
import es.karmadev.locklogin.migrator.util.argument.type.BooleanArgument;
import es.karmadev.locklogin.migrator.util.argument.type.EnumArgument;
import es.karmadev.locklogin.migrator.util.argument.type.StringArgument;
import es.karmadev.locklogin.migrator.util.argument.type.numeric.*;
